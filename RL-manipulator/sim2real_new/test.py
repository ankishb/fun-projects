...
if __name__ == "__main__":
    ...
    parser.add_argument("--valid_goals", action="store_true",default=True)  # Frequency of delayed policy updates
    parser.add_argument("--use_real_robot", action="store_true",default=False)
    parser.add_argument("--file_name", type=str,default="LocoBotEnv-v0_0_6dof")  # Frequency of delayed policy updates
    parser.add_argument("--directory", type=str,default="/home/amrut/pyrobot_6Dof/sim2real/log/ur10/pytorch_models")  # Frequency of delayed policy updates
