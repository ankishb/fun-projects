...
if __name__ == "__main__":
    ...
    parser.add_argument("--stop_on_hit",
                        action="store_true",default=True)  # if check collision is true, then whether to end episode on collision
    ...
    parser.add_argument("--valid_goals", action="store_true",default=True)  # while training, whether to sample valid goals or not
    ...
    parser.add_argument("--renders",type=str,default=True)  # whether want to visualize in GUI mode
